...
const API_URL = 'https://waterproject-harrison-backend-cnc7dhbjbvfvaehd.westus2-01.azurewebsites.net/api/water';
...
export const fetchProjects = async (
    ...
    try {
        ...
        const url = `${API_URL}/get-all-projects?pageSize=${pageSize}&pageNum=${pageNum}${selectedCategories.length ? `&${categoryParams}` : ''}`;
